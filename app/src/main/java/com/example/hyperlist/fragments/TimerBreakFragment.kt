...
class TimerBreakFragment : Fragment() {
    ...
    private var initialTime : Long = 120000
    ...
    private fun createTimer(start: Long, interval: Long, view: View): CountDownTimer {
        ...
        return object : CountDownTimer(start, interval) {
            ...
            override fun onFinish() {
                ...
                started = false
                paused = false
                view.findNavController().navigate(R.id.timerWorkFragment)
            }
        }
    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_timer_break, container, false)
    }
